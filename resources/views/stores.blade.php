...
<body>
    <div id="app">
        ...
        <div class="stores container">
            <h2 class="latestProductTitle">STORES</h2>
            @foreach ($users->chunk(3) as $row)
                <div class="storesRow row">
                    @foreach ($row as $user)
                        <div class="storeUserCard card">
                            <img class="storeProductImg card-img-top"
                                src="https://img.etimg.com/thumb/width-1200,height-900,imgsize-122620,resizemode-1,msid-75214721/industry/services/retail/future-group-negotiates-rents-for-its-1700-stores.jpg" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="name card-title">{{ $user->name }}</h5>
                                <div class="storeProductButtonContainer">
                                    <a href="/{{ $user->id }}" class="btn btn-primary">Visit
                                        Now</a>
                                </div>
                            </div>
                        </div>
